...
public final class TestSportByEnumeration {
    ...
    public static void main(final String... args) {
        ...
        SportSocialNetworkUserImpl<User> fiore = new  SportSocialNetworkUserImpl<>("Riccardo", "Fiorani", "rickyfiore01", 20);
        SportSocialNetworkUserImpl<User> palla = new  SportSocialNetworkUserImpl<>("Luca", "Perlini", "palla_swag");
        SportSocialNetworkUserImpl<User> morbi = new  SportSocialNetworkUserImpl<>("Luca", "Morbidelli", "jeans_stretti_joint_pieni");
        
        System.out.println("Panini hates doing sport (except having sex): " + true);
        ...
        System.out.println("Fiore has been involeved in plenty of car crashes while doing " + Sport.BIKE + ": " + fiore.hasSport(Sport.BIKE));
        ...
        System.out.println("Palla said a lot of bad words while doing " + Sport.BIKE + ": " + palla.hasSport(Sport.BIKE));
        System.out.println("Palla said even more bad words while doing " + Sport.VOLLEY + " then when he was biking: " + palla.hasSport(Sport.BIKE));
        ...
        System.out.println("Morbi isn't as good as he thinks playing " + Sport.VOLLEY + ": " + morbi.hasSport(Sport.VOLLEY));
    }
}
